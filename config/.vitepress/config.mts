...
const teekConfig = defineTeekConfig({
	...
	banner: {
		...
		imgSrc: ['/images/1.jpg'] // Banner 背景图片地址，字符串或字符串数组，当为数组时可设置 imgInterval 和 imgShuffle
	},
	post: {
		postStyle: 'card',
		...
		cardStyleTitleTagPosition: 'right', // 卡片模式下的标题标签位置（postStyle 为 card）
		defaultCoverImg: ['/images/4.png'] // 默认封面图地址，如果不设置封面图则使用默认封面图地址
	},
	page: {
		pageSize: 12, // 每页文章数量
